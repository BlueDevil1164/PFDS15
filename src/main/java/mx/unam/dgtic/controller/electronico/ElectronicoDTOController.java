package mx.unam.dgtic.controller.electronico;
...
public class ElectronicoDTOController {
    ...
    @PostMapping(path = "/")
    public ResponseEntity<ElectronicoDTO> createAlumnoDTO(
    ...
    public ResponseEntity<ElectronicoDTO> updateAlumnoDTO(@PathVariable String matricula, @RequestBody ElectronicoDTO electronico) throws ParseException, CategoriaNoExisteExepcion {
    ...
    public ResponseEntity<List<ElectronicoDTO>> getByEstado(@PathVariable String cat) {
